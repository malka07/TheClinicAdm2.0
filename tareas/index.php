...
<html>
  <head>
    ...
    <title>JDL S.A - Asignaciones De Tareas</title>
  ...
  <div class="row">
    ...
    <div class="col-sm-2"><h2>
		...
		onclick=location.href='tareas.php'; onKeyPress=location.href='tareas.php';
...
?>    
		...
		<div class="list-group">
				...
				<a 	<?php echo "href=modifica.php?id_tar=".$tareas[$i]['id_tar'];?>
						 class="list-group-item">
				<h4 class="list-group-item-heading"> <?php echo $tareas[$i]['id_tar'] ."";?> </h4>
				<p class="list-group-item-text"><?php 	echo "Fecha De Tarea: " . $tareas[$i]['fech_tar'] ." - Descripcion: "; 
                            echo $tareas[$i]['desc_tar'] ." - Tiempo Duracion: "; 
                            echo $tareas[$i]['tiemp_tar'] ." - Integrante: "; 
                            echo $tareas[$i]['inte_tar'] ." - Observaciones: ";
                            echo $tareas[$i]['obser_tar'] ."";
														?></p>		 
				</a>	</div>
	<?php  } ?>
