...
<html>
  ...
  <div class="row">
    ...
    <div class="col-sm-2"><h2>
		<img border="0" src="../img/nuevo.png" width="48" height="48" title="Ingresar Medicamento" 
		onclick=location.href='medicamentos.php'; onKeyPress=location.href='medicamentos.php';
...
?>    
    ...
    <a 	<?php echo "href=modifica.php?id_medicamento=".$medicamentos[$i]['id_medicamento'];?>
        ...
        <p class="list-group-item-text"><?php 	echo "Nombre: " . $medicamentos[$i]['nombre_medicamento'] ." - Fármaco: "; 
                            ...
                            echo $medicamentos[$i]['cantidad_medicamento'] ." - Vencimiento: ";  
                            echo $medicamentos[$i]['vencimiento_medicamento'] ."";
														?></p>		 
				</a>
    	</div>
	<?php  } ?>
