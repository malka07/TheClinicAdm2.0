...
?>
  ...
  <div class="py-5 text-center">
	<p class="text-danger" >IMPORTANTE!: Al eliminar el Usuario ,se eliminarán 
...
<hr class="mb-4">
        <button class="btn btn-warning btn-lg btn-block" type="button">Si,Deseo Eliminar A El Usuario / servicio</button>
