...
<a href="borra.php?id_int=<?PHP echo $_GET['id_int']; ?>">	 
<hr class="mb-4">
        <button class="btn btn-warning btn-lg btn-block" type="button">Si,Deseo Eliminar A El Integrante / servicio</button>
