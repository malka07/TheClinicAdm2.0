...
<div align="center">
 ...
 <table border="1" cellpadding="0" cellspacing="0"  bordercolor="#CCCCCC" style="border-collapse: collapse" width="90%">
  ...
  <tr>
      ...
      <td width="20%" height="35"><p align="center"><font face="Verdana" size="4" >Direccion</font></i></td>
  ...
  <tr>
    ...
    <td width="20%" height="35">  <p align="center"><font face="Verdana" size="4" ><?php echo $integrantes[$i]['edad_int'];?></font></i></td>
    <td width="20%" height="35">  <p align="center"><font face="Verdana" size="4" ><?php echo $integrantes[$i]['direc_int'];?></font></i></td>
    <td width="20%" height="35">  <p align="center"><font face="Verdana" size="4" ><?php echo $integrantes[$i]['fech_int'];?></font></i></td>
    <td width="20%" height="35">  <p align="center"><font face="Verdana" size="4" ><?php echo $integrantes[$i]['nota_int'];?></font></i></td>
