...
<script src="https://stackpath.bootstrapcdn.com/bootstrap/4.5.0/js/bootstrap.min.js" integrity="sha384-OgVRvuATP1z7JjHLkuOU7Xw704+h835Lr+6QL9UvYjZE3Ipu6Tp75j7Bh/kR0JKI" crossorigin="anonymous"></script>
  ...
  <div class="py-5 text-center">
    ...
    <h2>JDL S.A</h2>
    <p class="lead">Ingreso De Integrantes y Servicios / Profesiones para la App.</p>
  </div>
...
<?php
 ...
 $sql = "insert into integrantes(
  nom_int,ape_int,edad_int,direc_int,fech_int,nota_int)
  values" 
  . "('".$_POST['nom_int'] 	. "'," 
  . "'" .$_POST['ape_int'] 	. "',"
  . "'" .$_POST['edad_int'] 	. "',"	
...
if ($mysqli->query($sql) === TRUE) {
  ...
  echo "  <a href='../integrante/'> <div class='col-md-12 order-md-1'>";
